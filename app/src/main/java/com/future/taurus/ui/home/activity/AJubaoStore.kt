...
import kotlinx.android.synthetic.main.activity_ajubao_store.toolbar
import kotlinx.android.synthetic.main.activity_astore_detail.*

class AJubaoStore : ABase() {
    val titleText = TextView(MyApplication.context)
    override fun layoutId(): Int = R.layout.activity_ajubao_store
